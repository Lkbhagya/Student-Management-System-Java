 ...
 * @author Ravi
 */
@WebServlet(name = "RegisterControllerSvt", urlPatterns = {"/RegisterControllerSvt"})
public class RegisterControllerSvt extends HttpServlet {
   ...
   // Connection con;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        pst.executeUpdate();
            ...
            Logger.getLogger(RegisterControllerSvt.class.getName()).log(Level.SEVERE, null, ex);
